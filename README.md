...
Objective: Hit and destroy all targets to win the level!
✨ Key Features
Slingshot Mechanics: Realistic pull-back and release physics.
Dynamic Gravity: Characters follow a parabolic arc once launched.
Collision System: Objects react differently based on the force and angle of impact.
Level Management: Game tracks progress and allows for level restarts.
